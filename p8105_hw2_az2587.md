...
**Conclusion** The pols\_month dataset has **822** rows and **9**
columns, the variables are year, month, gov\_gop, sen\_gop, rep\_gop,
gov\_dem, sen\_dem, rep\_dem, president. The set covers data from **1947
to 2015**.  
The snp dataset contains **787** rows and \*\*\*\*, the variables are
year, month, close. The set covers data from **1991 to 2090**.  
