...
The snp dataset contains **`r nrow(snp)`** rows and **`r ncol(ncol(snp))`**, the variables are `r colnames(snp)`. The set covers data from **`r min(snp$year)` to `r max(snp$year)`**. \
